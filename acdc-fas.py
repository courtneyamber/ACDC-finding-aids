...
def inventories():
    for collection in collections:
        process_collection(collection, collection.replace(" ","-") + "-raw-inventory.txt", collection.replace(" ","-")+ "-structured-inventory.txt")
...
def process_findingaid(collection):
    ...
    findingaid = template
    findingaid = findingaid.replace("[@[*? title ?*]@]",collection + " Collection")                                                                                                                                                                         collection
    findingaid = findingaid.replace("[@[*? creator ?*]@]","Creator: " + collection)                                                                     
